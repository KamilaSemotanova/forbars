...
import Josef from "./img/Josef-portret.jpeg";
import Vilém from "./img/vilem.jpg";
      ...
      <div className={style.contact__container}>
        ...
        <div className={style.card__box}>
          <div className={style.contact__card}>
            <img src={Josef} alt="Josef photo" className={style.card__img} />
          ...
          <div className={style.contact__card}>
            <img src={Vilém} alt="Vilém photo" className={style.card__img} />
